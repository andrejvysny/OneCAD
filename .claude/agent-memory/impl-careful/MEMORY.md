- [Frontend gotchas](frontend-gotchas.md) — engine doubles, overlay setHidden, Escape blur-commit guard, requestConfirm gate, label/strip/inspector three-host split, gestureLive echo
