...
- [worker/build stale worktree paths](worker-build-stale-worktree-paths.md) — sed-fix CMakeCache/Makefiles after a worktree rename instead of full reconfigure
