// Ported from OneCAD-CPP src/core/loop/LoopDetector.h @ b4ddcccc (2026-07-16)
/**
 * @file LoopDetector.h
...
struct AdjacencyGraph;  // W-WP3a: was `class` (defined as struct in AdjacencyGraph.h) — fixes -Wmismatched-tags
