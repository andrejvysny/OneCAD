// Ported from OneCAD-CPP src/core/sketch/SketchEntity.h @ b4ddcccc (2026-07-16)
/**
 * @file SketchEntity.h
...
public:
    ...
    // W-WP3a: JSON serialize/deserialize removed (Rust-owned). Entities are
    // constructed programmatically; the worker receives sketch state via the
    // protocol (W-WP3b).
